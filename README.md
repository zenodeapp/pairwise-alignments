# Pairwise Alignments
A Solidity implementation of well-known alignment methods like Needleman-Wunsch's global sequence alignment and Smith-Waterman's local sequence alignment methods.
